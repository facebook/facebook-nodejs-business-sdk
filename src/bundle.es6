...
export { default as AdAccountAccountControls } from './../src/objects/ad-account-account-controls';
export { default as AdAccountAccountControlsPost } from './../src/objects/ad-account-account-controls-post';
...
export { default as AdAccountAdVideos } from './../src/objects/ad-account-ad-videos';
export { default as AdAccountAdVideosGet } from './../src/objects/ad-account-ad-videos-get';
...
export { default as AdAccountAdsReportingReportSpecs } from './../src/objects/ad-account-ads-reporting-report-specs';
export { default as AdAccountAdsReportingReportSpecsGet } from './../src/objects/ad-account-ads-reporting-report-specs-get';
...
export { default as AdAccountCreativeStickers } from './../src/objects/ad-account-creative-stickers';
export { default as AdAccountCreativeStickersPost } from './../src/objects/ad-account-creative-stickers-post';
...
export { default as AdAccountGet } from './../src/objects/ad-account-get';
...
export { default as AdCampaign } from './../src/objects/ad-campaign';
export { default as AdCampaignBidConstraint } from './../src/objects/ad-campaign-bid-constraint';
export { default as AdCampaignBudgetSchedules } from './../src/objects/ad-campaign-budget-schedules';
export { default as AdCampaignBudgetSchedulesPost } from './../src/objects/ad-campaign-budget-schedules-post';
export { default as AdCampaignCallingSettings } from './../src/objects/ad-campaign-calling-settings';
export { default as AdCampaignConversionValueExpressionSpec } from './../src/objects/ad-campaign-conversion-value-expression-spec';
export { default as AdCampaignDelete } from './../src/objects/ad-campaign-delete';
...
export { default as AdCampaignGroupBudgetSchedules } from './../src/objects/ad-campaign-group-budget-schedules';
export { default as AdCampaignGroupBudgetSchedulesPost } from './../src/objects/ad-campaign-group-budget-schedules-post';
export { default as AdCampaignGroupDelete } from './../src/objects/ad-campaign-group-delete';
...
export { default as AdCampaignMessagingStructuredLeadSpec } from './../src/objects/ad-campaign-messaging-structured-lead-spec';
...
export { default as AdCampaignPlacement } from './../src/objects/ad-campaign-placement';
export { default as AdCampaignPlacementGet } from './../src/objects/ad-campaign-placement-get';
...
export { default as AdCreativeAppExperienceSpec } from './../src/objects/ad-creative-app-experience-spec';
export { default as AdCreativeAssetGroupsSpec } from './../src/objects/ad-creative-asset-groups-spec';
export { default as AdCreativeAutomationSpec } from './../src/objects/ad-creative-automation-spec';
export { default as AdCreativeBizAI } from './../src/objects/ad-creative-biz-ai';
...
export { default as AdCreativeGet } from './../src/objects/ad-creative-get';
...
export { default as AdCreativeLiveVideoReminder } from './../src/objects/ad-creative-live-video-reminder';
...
export { default as AdCreativeProductSuggestionSettings } from './../src/objects/ad-creative-product-suggestion-settings';
...
export { default as AdCreativeWAMOWhatsAppIdentitySpec } from './../src/objects/ad-creative-wamo-whats-app-identity-spec';
...
export { default as Adgroup } from './../src/objects/adgroup';
export { default as AdgroupDelete } from './../src/objects/adgroup-delete';
...
export { default as AdsInsightsCampaign } from './../src/objects/ads-insights-campaign';
export { default as AdsInsightsCampaignGet } from './../src/objects/ads-insights-campaign-get';
...
export { default as AdsPixelCustomAttributionSource } from './../src/objects/ads-pixel-custom-attribution-source';
...
export { default as AdsSubscription } from './../src/objects/ads-subscription';
export { default as AdsSubscriptionDelete } from './../src/objects/ads-subscription-delete';
export { default as AdsSubscriptionGet } from './../src/objects/ads-subscription-get';
...
export { default as ArticlesAndPublicationsItem } from './../src/objects/articles-and-publications-item';
export { default as ArticlesAndPublicationsItemDelete } from './../src/objects/articles-and-publications-item-delete';
...
export { default as BusinessAdsReportingReportSpecsGet } from './../src/objects/business-ads-reporting-report-specs-get';
...
export { default as BusinessRecommendations } from './../src/objects/business-recommendations';
export { default as BusinessRecommendationsGet } from './../src/objects/business-recommendations-get';
...
export { default as CatalogDuplicateData } from './../src/objects/catalog-duplicate-data';
export { default as CatalogGenericFeeds } from './../src/objects/catalog-generic-feeds';
export { default as CatalogGenericFeedsGet } from './../src/objects/catalog-generic-feeds-get';
export { default as CatalogGenericIngestionSessionErrors } from './../src/objects/catalog-generic-ingestion-session-errors';
export { default as CatalogGenericIngestionSessionErrorsGet } from './../src/objects/catalog-generic-ingestion-session-errors-get';
...
export { default as CatalogSubscribedApps } from './../src/objects/catalog-subscribed-apps';
export { default as CatalogSubscribedAppsDelete } from './../src/objects/catalog-subscribed-apps-delete';
...
export { default as CreativeAudiencePairingPersona } from './../src/objects/creative-audience-pairing-persona';
export { default as CreativeFatiguePredictionPLE } from './../src/objects/creative-fatigue-prediction-ple';
...
export { default as CustomAttributionDataset } from './../src/objects/custom-attribution-dataset';
...
export { default as CustomAudienceMatchRateInsights } from './../src/objects/custom-audience-match-rate-insights';
...
export { default as HighDemandPeriodGet } from './../src/objects/high-demand-period-get';
...
export { default as HomeListingGet } from './../src/objects/home-listing-get';
...
export { default as IntegrityAppeal } from './../src/objects/integrity-appeal';
export { default as IntegrityAppealGetAdAppealBulkEligibility } from './../src/objects/integrity-appeal-get-ad-appeal-bulk-eligibility';
export { default as IntegrityAppealGetAdAppealBulkStatus } from './../src/objects/integrity-appeal-get-ad-appeal-bulk-status';
export { default as IntegrityAppealGetAdAppealEligibility } from './../src/objects/integrity-appeal-get-ad-appeal-eligibility';
export { default as IntegrityAppealGetAdAppealStatus } from './../src/objects/integrity-appeal-get-ad-appeal-status';
export { default as IntegrityAppealPostAdAppealBulk } from './../src/objects/integrity-appeal-post-ad-appeal-bulk';
...
export { default as LeadNurturingState } from './../src/objects/lead-nurturing-state';
...
export { default as MetaMomentMakerConfig } from './../src/objects/meta-moment-maker-config';
...
export { default as OpportunityScoreChangelog } from './../src/objects/opportunity-score-changelog';
export { default as OpportunityScoreChangelogGet } from './../src/objects/opportunity-score-changelog-get';
...
export { default as PageCTXBudgetDFOBudgetRecommendation } from './../src/objects/page-ctx-budget-dfo-budget-recommendation';
...
export { default as PageOwnedProductCatalog } from './../src/objects/page-owned-product-catalog';
export { default as PageOwnedProductCatalogPost } from './../src/objects/page-owned-product-catalog-post';
...
export { default as PageRecommendedPostsInfo } from './../src/objects/page-recommended-posts-info';
...
export { default as PartnerAppAndWelcomeMessageFlowData } from './../src/objects/partner-app-and-welcome-message-flow-data';
...
export { default as PartnershipAdContentListSpec } from './../src/objects/partnership-ad-content-list-spec';
...
export { default as ProductCatalogActivities } from './../src/objects/product-catalog-activities';
export { default as ProductCatalogActivitiesItem } from './../src/objects/product-catalog-activities-item';
export { default as ProductCatalogActivitiesItemDelete } from './../src/objects/product-catalog-activities-item-delete';
export { default as ProductCatalogActivitiesPost } from './../src/objects/product-catalog-activities-post';
export { default as ProductCatalogAppsAndSoftware } from './../src/objects/product-catalog-apps-and-software';
export { default as ProductCatalogAppsAndSoftwareItem } from './../src/objects/product-catalog-apps-and-software-item';
export { default as ProductCatalogAppsAndSoftwareItemDelete } from './../src/objects/product-catalog-apps-and-software-item-delete';
export { default as ProductCatalogAppsAndSoftwarePost } from './../src/objects/product-catalog-apps-and-software-post';
export { default as ProductCatalogArticlesAndPublications } from './../src/objects/product-catalog-articles-and-publications';
export { default as ProductCatalogArticlesAndPublicationsPost } from './../src/objects/product-catalog-articles-and-publications-post';
export { default as ProductCatalogCategory } from './../src/objects/product-catalog-category';
export { default as ProductCatalogCheckBatchRequestStatus } from './../src/objects/product-catalog-check-batch-request-status';
export { default as ProductCatalogCheckBatchRequestStatusGet } from './../src/objects/product-catalog-check-batch-request-status-get';
...
export { default as ProductCatalogDataSources } from './../src/objects/product-catalog-data-sources';
export { default as ProductCatalogDataSourcesGet } from './../src/objects/product-catalog-data-sources-get';
...
export { default as ProductCatalogHotels } from './../src/objects/product-catalog-hotels';
export { default as ProductCatalogHotelsGet } from './../src/objects/product-catalog-hotels-get';
export { default as ProductCatalogHotelsItem } from './../src/objects/product-catalog-hotels-item';
export { default as ProductCatalogHotelsItemGet } from './../src/objects/product-catalog-hotels-item-get';
...
export { default as ProductCatalogItemsBatch } from './../src/objects/product-catalog-items-batch';
export { default as ProductCatalogItemsBatchPost } from './../src/objects/product-catalog-items-batch-post';
export { default as ProductCatalogLocalizationSettings } from './../src/objects/product-catalog-localization-settings';
export { default as ProductCatalogMediaTitle } from './../src/objects/product-catalog-media-title';
export { default as ProductCatalogMediaTitleDelete } from './../src/objects/product-catalog-media-title-delete';
export { default as ProductCatalogMediaTitles } from './../src/objects/product-catalog-media-titles';
export { default as ProductCatalogMediaTitlesPost } from './../src/objects/product-catalog-media-titles-post';
export { default as ProductCatalogPost } from './../src/objects/product-catalog-post';
export { default as ProductCatalogPricingVariablesBatch } from './../src/objects/product-catalog-pricing-variables-batch';
export { default as ProductCatalogProductSets } from './../src/objects/product-catalog-product-sets';
export { default as ProductCatalogProductSetsBatch } from './../src/objects/product-catalog-product-sets-batch';
export { default as ProductCatalogProductSetsGet } from './../src/objects/product-catalog-product-sets-get';
export { default as ProductCatalogProducts } from './../src/objects/product-catalog-products';
export { default as ProductCatalogProductsPost } from './../src/objects/product-catalog-products-post';
export { default as ProductCatalogProfessionalServices } from './../src/objects/product-catalog-professional-services';
export { default as ProductCatalogProfessionalServicesItem } from './../src/objects/product-catalog-professional-services-item';
export { default as ProductCatalogProfessionalServicesItemPut } from './../src/objects/product-catalog-professional-services-item-put';
export { default as ProductCatalogProfessionalServicesPost } from './../src/objects/product-catalog-professional-services-post';
...
export { default as ProductFeedActivities } from './../src/objects/product-feed-activities';
export { default as ProductFeedActivitiesGet } from './../src/objects/product-feed-activities-get';
export { default as ProductFeedAppsAndSoftware } from './../src/objects/product-feed-apps-and-software';
export { default as ProductFeedAppsAndSoftwareGet } from './../src/objects/product-feed-apps-and-software-get';
export { default as ProductFeedArticlesAndPublications } from './../src/objects/product-feed-articles-and-publications';
export { default as ProductFeedArticlesAndPublicationsGet } from './../src/objects/product-feed-articles-and-publications-get';
export { default as ProductFeedDelete } from './../src/objects/product-feed-delete';
export { default as ProductFeedHotels } from './../src/objects/product-feed-hotels';
export { default as ProductFeedHotelsGet } from './../src/objects/product-feed-hotels-get';
export { default as ProductFeedMediaTitles } from './../src/objects/product-feed-media-titles';
export { default as ProductFeedMediaTitlesGet } from './../src/objects/product-feed-media-titles-get';
export { default as ProductFeedProfessionalServices } from './../src/objects/product-feed-professional-services';
export { default as ProductFeedProfessionalServicesGet } from './../src/objects/product-feed-professional-services-get';
export { default as ProductFeedRule } from './../src/objects/product-feed-rule';
export { default as ProductFeedRuleGet } from './../src/objects/product-feed-rule-get';
...
export { default as ProductFeedRules } from './../src/objects/product-feed-rules';
export { default as ProductFeedRulesGet } from './../src/objects/product-feed-rules-get';
...
export { default as ProductFeedUploadGet } from './../src/objects/product-feed-upload-get';
...
export { default as ProductGroupGet } from './../src/objects/product-group-get';
...
export { default as ProductItemPost } from './../src/objects/product-item-post';
export { default as ProductItemProductDisclosure } from './../src/objects/product-item-product-disclosure';
...
export { default as ProductSetActivities } from './../src/objects/product-set-activities';
export { default as ProductSetActivitiesGet } from './../src/objects/product-set-activities-get';
export { default as ProductSetAppsAndSoftware } from './../src/objects/product-set-apps-and-software';
export { default as ProductSetAppsAndSoftwareGet } from './../src/objects/product-set-apps-and-software-get';
export { default as ProductSetArticlesAndPublications } from './../src/objects/product-set-articles-and-publications';
export { default as ProductSetArticlesAndPublicationsGet } from './../src/objects/product-set-articles-and-publications-get';
export { default as ProductSetHotels } from './../src/objects/product-set-hotels';
export { default as ProductSetHotelsGet } from './../src/objects/product-set-hotels-get';
export { default as ProductSetMediaTitles } from './../src/objects/product-set-media-titles';
export { default as ProductSetMediaTitlesGet } from './../src/objects/product-set-media-titles-get';
export { default as ProductSetMetadata } from './../src/objects/product-set-metadata';
export { default as ProductSetPost } from './../src/objects/product-set-post';
export { default as ProductSetProfessionalServices } from './../src/objects/product-set-professional-services';
export { default as ProductSetProfessionalServicesGet } from './../src/objects/product-set-professional-services-get';
...
export { default as RTBDynamicPostComments } from './../src/objects/rtb-dynamic-post-comments';
export { default as RTBDynamicPostCommentsPost } from './../src/objects/rtb-dynamic-post-comments-post';
...
export { default as RepeatReachState } from './../src/objects/repeat-reach-state';
...
export { default as ShadowIGUserCollaborativeMedia } from './../src/objects/shadow-ig-user-collaborative-media';
...
export { default as ValueRulesSpec } from './../src/objects/value-rules-spec';
